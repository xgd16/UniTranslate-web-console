<template>
  <el-row>
    <el-form-item label="accessKey" class="el-col-sm-24 p5px">
      <el-input type="text" v-model="props.config.accessKey"></el-input>
    </el-form-item>
    <el-form-item label="secretKey" class="el-col-sm-24 p5px">
      <el-input type="text" v-model="props.config.secretKey"></el-input>
    </el-form-item>
  </el-row>
</template>
...
import type { HuoShanConfig as configType } from "@/types/props";
